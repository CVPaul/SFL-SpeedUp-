...
function [outMatrix beta] = Compute_LERM_Sim(Set1,Set2,simFlag,beta)
% if nargin<4
%     beta=1;
% end
if nargin<3
...
if (simFlag)
    for tmpC1 = 1:l1
        for tmpC2 = tmpC1:l2
            ...
            outMatrix(tmpC2,tmpC1) = sqrt(temp(:)'*temp(:));
...
if nargin<4
    beta = 1/(2*mean(outMatrix(:))^2);
end
outMatrix=exp(-beta*outMatrix.^2);
end